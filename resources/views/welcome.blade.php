                ...
                <div class="col-md-7 mb-50">
                    <div class="info-about">
                        ...
                        <div class="row mb-10">
                            ...
                            <div class="col-sm-6">
                                <p class="mb-25">FACNEX started as a small metalworking company specializing in forming bonded metals for a variety of industries. The founder of the company, NOUR ELDIN, realized that combining different minerals produces compounds that give excellent results.</p>
                ...
                <div class="col-md-5 mb-50">
                    <div class="about-img-one">
                        <div class="owl-carousel about-carousel">
                            <div class="owl-item">
                                <img src="http://placehold.it/788x767" alt="img">
                            </div>
                            <div class="owl-item">
                                <img src="http://placehold.it/788x767" alt="img">
                            </div>
                ...
                <div class="services-item-one">
                    <div class="owl-item"> 
                        ...
                        <div class="content-box">
                            ...
                            <h4> Mechanical   <br> Constructions</h4>
                            <p>Lorem Ipsum simply dummy text of the printing typesetting industry simply dummy text typesetting.</p>
                ...
                <div class="services-item-one">
                    <div class="owl-item"> 
                        ...
                        <div class="content-box">
                            ...
                            <h4>Chemical Research <br>  Industry </h4>
                            <p>Lorem Ipsum simply dummy text of the printing typesetting industry simply dummy text typesetting.</p>
                ...
                <div class="services-item-one">
                    <div class="owl-item"> 
                        ...
                        <div class="content-box">
                            ...
                            <h4>Petroleum & Gas <br> Engineering </h4>
                            <p>Lorem Ipsum simply dummy text of the printing typesetting industry simply dummy text typesetting.</p>
                ...
                <div class="services-item-one">
                    <div class="owl-item"> 
                        ...
                        <div class="content-box">
                            ...
                            <h4>Robot Production <br> & Safety</h4>
                            <p>Lorem Ipsum simply dummy text of the printing typesetting industry simply dummy text typesetting.</p>
                ...
                <div class="services-item-one">
                    <div class="owl-item"> 
                        ...
                        <div class="content-box">
                            ...
                            <h4>Energy Distribution <br> & Grids</h4>
                            <p>Lorem Ipsum simply dummy text of the printing typesetting industry simply dummy text typesetting.</p>
                        ...
                        <div class="owl-item"> 
                            <div class="testmonail-box">
                                ...
                                <div class="inner-test">
                                    <p class="text">
                                    "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusm tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat adipisicing elit."
                                    </p>
                                </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="item-team">
                    <div class="team-one-item">
                        <!-- Image OF Team -->
                        <img src="http://placehold.it/500x600" alt="team">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="blog-item">
                    <!-- Blog Image -->
                    <div class="blog-img">
                        <a href="blog.html"><img src="http://placehold.it/680x400" alt="blog"></a>
